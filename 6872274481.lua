		...
		Function = function(callback)
			if callback then
				...
				if entityLibrary.isAlive and echest then
					task.spawn(function()
						local chestitems = store.localInventory.inventory.items
				...
				table.insert(AutoBank.Connections, replicatedStorage.Inventories.DescendantAdded:Connect(function(p3)
